...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action divaction">
		...
		<div class="pages">
	<!--请假申请 区域 开始-->
	<s:form action="leave_saveLeave.action" name="leaveForm" theme="simple">
     <table class="leave">
       <tr>
         <td class="width1"><label for="name">姓名：</label></td>
         <td class="width2"><s:textfield name="name" value="%{#session.employee.name}" cssClass="nwinput" theme="simple"/></td>
         <s:hidden name="leave.creator.sn" value="%{#session.employee.sn}" theme="simple"></s:hidden>
        ...
        <tr>
         ...
         <td class="width2"><s:textfield name="leave.startTime" id="startDate" cssClass="nwinput" theme="simple"/></td>
         <td class="width1"><label for="end-time">结束时间：</label></td>
         <td class="width2"><s:textfield name="leave.endTime" id="endDate" cssClass="nwinput" theme="simple"/></td>
       </tr>
        <tr>
         <td class="width1"><label for="size">请假天数：</label></td>
         <td class="width2"><s:textfield name="leave.leaveDay"  cssClass="nwinput" theme="simple"/>(天)</td>
       ...
       <tr>
         ...
         <td colspan="3">
          <s:textarea name="leave.reason" cssClass="textarea" theme="simple"></s:textarea>
         </td>
       </tr>
     </table>
     <br/>
          ...
          <p class="leave">
           <label>下一审批人：</label>
           <s:select class="nwselect" id="deal" name="leave.nextDeal.sn" list="#session.manager" listKey="sn" listValue="name" headerKey="" headerValue="--请选择--" theme="simple"></s:select>
