	...
	<body>
		<div class="action  divaction">
			...
			<div class="pages">
				...
				<s:form action="leave_checkLeave.action" name="leaveForm" theme="simple">
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					class="addform-base">
					<tr>
						<td>
					...
					<tr>
						<td colspan="4" class="submit">
							...
							<s:hidden id="leaveId" name="leave.id" value="%{leave.id}" theme="simple"/>
							<s:hidden id="status" name="leave.status" value="" theme="simple"/>
