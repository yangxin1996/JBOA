...
<div class="action  divaction">
	...
	<div class="pages">
		<div class="forms">
			 <s:form action="claimVoucher_searchClaimVoucher.action" name="queryForm"  theme="simple">
	       		<label>报销单状态</label>
		       ...
		       <s:textfield name="startDate" id="startDate" cssClass="nwinput"  theme="simple"></s:textfield>
		       <label for="end-time">结束时间</label>
		       <s:textfield name="endDate" id="endDate" cssClass="nwinput"  theme="simple"></s:textfield>
	...
	<s:form action="claimVoucher_searchClaimVoucher.action" name="claimVoucherForm">
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="#page.records" id="claimVoucher" begin="0" status="s">
	      <%-- <s:iterator value="claimVoucherList" id="claimVoucher" begin="0" status="s"> --%>
	      <tr>
	        ...
	        <td>
		        ...
		        <s:if test="#claimVoucher.nextDeal.name == #session.employee.name">
		        	<s:if test="#claimVoucher.status == '已提交' || #claimVoucher.status == '已审阅' || #claimVoucher.status == '已审批'">
	      ...
	      <tr>
	        <td colspan="6" align="center">
				...
				<c:param name="totalRecords" value="${page.totalRecords}"/>
				<c:param name="totalPageNum" value="${page.totalPageNum}"/>
				<c:param name="currentPageNum" value="${page.currentPageNum}"/>
				<c:param name="prePageNum" value="${page.prePageNum}"/>
				<c:param name="nextPageNum" value="${page.nextPageNum}"/>
  				</c:import> 
  		  	</td>
  		  </tr>
	    </table>      
