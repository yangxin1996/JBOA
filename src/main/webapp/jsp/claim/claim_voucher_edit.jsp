...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action  divaction">
		...
		<div class="pages">
			<s:form action="claimVoucher_saveClaimVoucher.action" name="claimForm" meth="post">
			
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="rowNumber"/>"/>
			<!-- <input type="hidden" id="createTime" name="claimVoucher.createTime" value="2018-8-8 20:45:45"/> -->
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						<td>*填报人：</td>
						<td><s:property value="#session.employee.name"/></td>
						<td>*负责人：</td>						
						<td><s:select id="deal" name="claimVoucher.nextDeal.sn" list="#session.manager" listKey="sn" listValue="name" headerKey="" headerValue="--请选择--" theme="simple"></s:select>
						</td>
					</tr>
